    ...
    return (
        <div className="min-h-screen bg-ctp-base text-ctp-text font-sans flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 relative overflow-hidden">
                ...
                <div className="bg-ctp-surface0/50 border border-ctp-surface1 px-4 py-1.5 rounded-full mb-8 text-sm font-medium text-ctp-blue animate-[slideUp_0.4s_ease-out]">
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 max-w-4xl leading-tight animate-[slideUp_0.5s_ease-out]">
                    Turn Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-ctp-mauve to-ctp-blue">Tasks</span> Into <span className="text-transparent bg-clip-text bg-gradient-to-r from-ctp-blue to-ctp-green">Quests</span>
                </h1>

                <p className="text-xl text-ctp-subtext0 max-w-2xl mb-10 leading-relaxed animate-[slideUp_0.6s_ease-out]">
                    LevelUp transforms boring assignments into an RPG adventure. Earn XP, unlock achievements, and compete on the global leaderboard.
                </p>
...
function FeatureCard({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
    return (
        <div className="bg-ctp-surface0 p-8 rounded-2xl border border-ctp-surface1 hover:border-ctp-mauve/50 transition-colors group">
            <div className="mb-6 p-4 bg-ctp-base rounded-xl inline-block shadow-inner group-hover:scale-110 transition-transform duration-300">
                {icon}
            </div>
